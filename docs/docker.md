...
- Set up your docker environment >
    ...
    - If you face problems with the previous `docker run` instruction not connecting to postgres, you should try running `docker run -v "<your_path>":/app -p 8080:8080 --add-host=host.docker.internal:host-gateway <your_image_name>:<your_image_tag>` instead. If you keep having problems, you should check your postgresql configuration files. Good luck!
